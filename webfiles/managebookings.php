...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
	...
	<body> <center> 
		<nav class="navbar navbar-default"> 
			<div class="pull-left" style="padding:5px">Sie sind eingeloggt als <span style='color:green'><?php echo $username ?></span> </br>
				<ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Buchungsverwaltung</li>
				</ol>
            </div>
        ...
        <!--make headline-->
			<h1 class='page-header'> Alle Buchungen aufgelistet </h1>
        
        <div class="col-md-4">
            <h4>Zeitraum filtern:</h4>
			<table class="table">
			<tr>
			<?php echo "<form action='managebookings.php' method='post'>"; ?>
...
<!-- -->
			...
			<tr>
				...
				while ($booking_arr = mysqli_fetch_array($res_booking_arr)) {
                    ...
                    echo "
							<form action='deletebooking.php?instname=".$booking_arr['iname']."' method='post'>
